...
class OtherStatus extends StatelessWidget {
  OtherStatus({Key key,this.imageName, this.name, this.time, this.isSeen, this.statusNum}):super(key: key);
...
class StatusPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
      final Paint paint = Paint() ..isAntiAlias = true ..strokeWidth = 6.0 ..color = isSeen ? Colors.grey[400] : Color(0xff21bfa6) ..style = PaintingStyle.stroke;
